...
# ============================================================
# Scalism 1.0 Standard — Hybrid Live ISO Builder
# Based on Debian 13 (Trixie) — General Hardware Support
...
ISO_NAME="scalism-1.0-std-amd64.iso"
...
DEBIAN_FRONTEND=noninteractive mmdebstrap \
  ...
  --customize-hook='
    # Hostname
    echo "scalism-std" > "$1/etc/hostname"
    echo "127.0.1.1 scalism-std" >> "$1/etc/hosts"
...
LIVE_HOSTNAME="scalism-std"
LIVE_USERNAME="root"
LIVE

    # OS branding
    cat > "$1/etc/os-release" <<OSREL
PRETTY_NAME="Scalism 1.0 Standard"
NAME="Scalism"
VERSION_ID="1.0"
VERSION="1.0"
ID=scalism
...
echo " ██████  ██████ ██   ██ ███████ ██ ███████ ██      ██"
echo ""
echo " Scalism 1.0 Standard — Bare-metal ready"
